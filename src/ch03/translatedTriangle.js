...
const VSHADER_SOURCE = `
  ...
  uniform vec4 uni_trans;
  void main() {
    gl_Position = attr_position + uni_trans;
    gl_PointSize = 10.0;
  }
`;
...
export default function main() {
  ...
  const uni_trans = gl.getUniformLocation(gl.program, 'uni_trans');
  const [Tx, Ty, Tz] = [0.5, 0.5, 0.0];
  gl.uniform4f(uni_trans, Tx, Ty, Tz, 0.0);
