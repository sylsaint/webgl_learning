...
export default function main() {
  ...
  document.onkeydown = function (ev) {
    keydown(ev, gl, n, uni_mat, viewMatrix);
  }
  draw(gl, n, uni_mat, viewMatrix);
...
function keydown(ev, gl, n, uni_mat, viewMatrix) {
  if (ev.keyCode === 39) {
    // arrowRight 
    g_eyeX += 0.01;
  }
  ...
  if (ev.ctrlKey && ev.keyCode === 189) {
    g_eyeZ -= 0.01;
  }
  if (ev.ctrlKey && ev.keyCode === 187) {
    g_eyeZ += 0.01;
  }
  draw(gl, n, uni_mat, viewMatrix);
}

function draw(gl, n, uni_mat, viewMatrix) {
  // set viewpoint
